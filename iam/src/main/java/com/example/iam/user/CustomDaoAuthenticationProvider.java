...
public class CustomDaoAuthenticationProvider
    extends AbstractCustomUserDetailsAuthenticationProvider {
  ...
  protected void additionalAuthenticationChecks(
    ...
    if (!passwordEncoder.matches(presentedPassword, userDetails.getPassword())) {
      ...
      throw new BadCredentialsException(
          messages.getMessage(
              "AbstractCustomUserDetailsAuthenticationProvider.badCredentials", "Bad credentials"));
    }
  }
  ...
  protected final CustomUserDetails retrieveUser(
