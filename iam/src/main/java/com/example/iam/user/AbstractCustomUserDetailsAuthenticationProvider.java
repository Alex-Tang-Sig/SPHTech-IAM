...
public abstract class AbstractCustomUserDetailsAuthenticationProvider
	...
	protected abstract void additionalAuthenticationChecks(CustomUserDetails userDetails,
	 ...
	 * <code>AbstractCustomUserDetailsAuthenticationProvider</code> will by default cache the
	 ...
	 * {@link #additionalAuthenticationChecks(UserDetails, EmailPasswordAuthenticationToken)}
	 ...
	 */
	protected abstract CustomUserDetails retrieveUser(String email,
			EmailPasswordAuthenticationToken authentication);
